...
const News = () => {
  ...
  return (
    <section
      id="news"
      className="bg-gradient-to-t from-slate-950 to-pink flex flex-col gap-5 items-center pt-20 pb-10"
    >
      {loading && (
      ...
      <div className="flex flex-row flex-wrap gap-8 items-center justify-center px-10">
        {loading && <Loading />}
